...
all: directories ./bin/boot.bin ./bin/kernel.bin user_programs
	...
	sudo cp ./data/images/terminal.bmp /mnt/d
	sudo cp ./data/images/settings.bmp /mnt/d
...
directories:
	mkdir -p ./bin ./build/string ./build/disk ./build/disk/drivers ./build/graphics ./build/graphics/image ./build/lib/vector ./build/isr80h ./build/keyboard ./build/loader/formats ./build/task ./build/gdt ./build/fs ./build/fs/fat ./build/memory ./build/memory/heap ./build/io ./build/usb ./build/memory/paging ./build/idt
...
./build/isr80h/window.o: ./src/isr80h/window.c
	x86_64-elf-gcc $(INCLUDES) -I./src/isr80h $(FLAGS) -std=gnu99 -c ./src/isr80h/window.c -o ./build/isr80h/window.o
...
./build/isr80h/serial.o: ./src/isr80h/serial.c
	x86_64-elf-gcc $(INCLUDES) -I./src/isr80h -I./src/usb $(FLAGS) -std=gnu99 -c ./src/isr80h/serial.c -o ./build/isr80h/serial.o
...
./build/io/tsc.asm.o: ./src/io/tsc.asm
	nasm -f elf64 -g ./src/io/tsc.asm -o ./build/io/tsc.asm.o

./build/io/tsc.o: ./src/io/tsc.c
	x86_64-elf-gcc $(INCLUDES) -I./src/io $(FLAGS) -std=gnu99 -c ./src/io/tsc.c -o ./build/io/tsc.o

./build/io/pci.o: ./src/io/pci.c
	x86_64-elf-gcc $(INCLUDES) -I./src/io $(FLAGS) -std=gnu99 -c ./src/io/pci.c -o ./build/io/pci.o

./build/usb/xhci.o: ./src/usb/xhci.c
	x86_64-elf-gcc $(INCLUDES) -I./src/usb $(FLAGS) -std=gnu99 -c ./src/usb/xhci.c -o ./build/usb/xhci.o

./build/usb/ehci.o: ./src/usb/ehci.c
	x86_64-elf-gcc $(INCLUDES) -I./src/usb $(FLAGS) -std=gnu99 -c ./src/usb/ehci.c -o ./build/usb/ehci.o

./build/usb/hidreport.o: ./src/usb/hidreport.c
	x86_64-elf-gcc $(INCLUDES) -I./src/usb $(FLAGS) -std=gnu99 -c ./src/usb/hidreport.c -o ./build/usb/hidreport.o

./build/io/cpuid.o: ./src/io/cpuid.c
	x86_64-elf-gcc $(INCLUDES) -I./src/io $(FLAGS) -std=gnu99 -c ./src/io/cpuid.c -o ./build/io/cpuid.o
...
./build/task/userlandptr.o: ./src/task/userlandptr.c
	x86_64-elf-gcc $(INCLUDES) -I./src/task $(FLAGS) -std=gnu99 -c ./src/task/userlandptr.c -o ./build/task/userlandptr.o
...
./build/keyboard/usbhid.o: ./src/keyboard/usbhid.c
	x86_64-elf-gcc $(INCLUDES) -I./src/keyboard $(FLAGS) -std=gnu99 -c ./src/keyboard/usbhid.c -o ./build/keyboard/usbhid.o
...
./build/mouse/mouse.o: ./src/mouse/mouse.c
	x86_64-elf-gcc $(INCLUDES) -I./src/mouse $(FLAGS) -std=gnu99 -c ./src/mouse/mouse.c -o ./build/mouse/mouse.o

./build/mouse/ps2mouse.o: ./src/mouse/ps2mouse.c
	x86_64-elf-gcc $(INCLUDES) -I./src/mouse $(FLAGS) -std=gnu99 -c ./src/mouse/ps2mouse.c -o ./build/mouse/ps2mouse.o

./build/mouse/usbhid_mouse.o: ./src/mouse/usbhid_mouse.c
	x86_64-elf-gcc $(INCLUDES) -I./src/mouse $(FLAGS) -std=gnu99 -c ./src/mouse/usbhid_mouse.c -o ./build/mouse/usbhid_mouse.o
...
./build/disk/driver.o: ./src/disk/driver.c
	x86_64-elf-gcc $(INCLUDES) -I./src/disk $(FLAGS) -std=gnu99 -c ./src/disk/driver.c -o ./build/disk/driver.o

./build/disk/drivers/nvme.o: ./src/disk/drivers/nvme.c
	x86_64-elf-gcc $(INCLUDES) -I./src/disk/drivers -I./src/disk $(FLAGS) -std=gnu99 -c ./src/disk/drivers/nvme.c -o ./build/disk/drivers/nvme.o


./build/disk/drivers/pata.o: ./src/disk/drivers/pata.c
	x86_64-elf-gcc $(INCLUDES) -I./src/disk/drivers -I./src/disk $(FLAGS) -std=gnu99 -c ./src/disk/drivers/pata.c -o ./build/disk/drivers/pata.o
