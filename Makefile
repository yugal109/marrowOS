...
FILES = ./build/kernel.asm.o ./build/kernel.o ./build/memory/heap/multiheap.o  ./build/string/string.o ./build/memory/paging/paging.o ./build/idt/idt.o ./build/idt/idt.asm.o  ./build/memory/paging/paging.asm.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/memory.o
$(FILES): | directories
INCLUDES = -I./src
...
directories:
	mkdir -p ./bin ./build/string ./build/memory/heap ./build/io ./build/memory/paging ./build/idt
