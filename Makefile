...
directories:
	mkdir -p ./bin ./build/string ./build/disk ./build/disk/drivers ./build/graphics ./build/graphics/image ./build/lib/vector ./build/isr80h ./build/keyboard ./build/loader/formats ./build/task ./build/gdt ./build/fs ./build/fs/fat ./build/memory ./build/memory/heap ./build/io ./build/memory/paging ./build/idt
