...
FILES = ./build/kernel.asm.o ./build/kernel.o ./build/mouse/mouse.o ./build/mouse/ps2mouse.o ./build/io/tsc.asm.o ./build/io/tsc.o  ./build/io/cpuid.o ./build/graphics/windows.o ./build/graphics/terminal.o ./build/graphics/font.o ./build/graphics/graphics.o ./build/graphics/image/image.o ./build/graphics/image/bmp.o ./build/disk/gpt.o ./build/lib/vector/vector.o ./build/idt/irq.o ./build/loader/formats/elf.o ./build/loader/formats/elfloader.o ./build/isr80h/isr80h.o ./build/isr80h/io.o ./build/isr80h/heap.o ./build/isr80h/misc.o ./build/isr80h/window.o ./build/isr80h/file.o ./build/isr80h/process.o ./build/keyboard/keyboard.o ./build/keyboard/classic.o ./build/gdt/gdt.o ./build/disk/disk.o ./build/disk/streamer.o ./build/fs/fat/fat16.o ./build/fs/file.o ./build/fs/pparser.o ./build/task/process.o ./build/task/userlandptr.o ./build/task/task.o ./build/memory/heap/multiheap.o ./build/memory/paging/paging.o  ./build/idt/idt.o ./build/idt/idt.asm.o ./build/task/tss.asm.o ./build/task/task.asm.o ./build/memory/paging/paging.asm.o ./build/io/io.asm.o ./build/string/string.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/memory.o
$(FILES): | directories
INCLUDES = -I./src
