...
#define MARROWOS_MEMORY_MAP_LOCATION 0x210008

// 16 Bit number defining the total number of loaded
// entries.
#define MARROWOS_MEMORY_MAP_TOTAL_ENTRIES_LOCATION 0x210000
...
// Rain (the editor's script runner) recurses while compiling, so 16 KB was too little
#define MARROWOS_USER_PROGRAM_STACK_SIZE (1024 * 64)
